...
class EventSeeder extends Seeder
{
    ...
    private const DEFAULT_CHUNK = 4000;

    // SQLite has a lower bound-variable limit. Each event row inserts 10 values.
    private const SQLITE_CHUNK = 90;
    ...
    public function insertEvents(int $count): void
    {
        ...
        while ($remaining > 0) {
            ...
            if ($done % ($chunkSize * 25) === 0 || $remaining === 0) {
